...
"RECTANGULO","COLOR","PRINT",0,0,0,"illegal-symbol",
};
...
#line 20 "forma.y"
	{ ((Algo)yyval.obj).inst=maq.code("constpush");
                maq.code(((Algo)yystack.l_mark[0].obj).simb); }
break;
case 5:
#line 24 "forma.y"
	{ 
         maq.code("constpush");
         maq.code(((Algo)yystack.l_mark[-3].obj).simb);

         maq.code("constpush");
         maq.code(((Algo)yystack.l_mark[-2].obj).simb);

         maq.code("constpush");
         maq.code(((Algo)yystack.l_mark[-1].obj).simb);
...
#line 71 "forma.y"
	{ maq.code("constpush");
                maq.code(((Algo)yystack.l_mark[0].obj).simb); maq.code("color");}
break;
#line 568 "y.tab.c"
    }
    yystack.s_mark -= yym;
